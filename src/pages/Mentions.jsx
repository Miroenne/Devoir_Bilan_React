            ...
            <div class="accordion container my-7 w-75 min-vh-43 justify-content-center align-items-center" id="mentionsAccordion">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                        ...
                        <p><em>Les images utilisées sur ce site sont libres de droits et ont été obtenues sur le site <a href="https://pixabay.com/fr/" className="d-inline text-primary text-decoration-underline" target="_blank">Pixabay</a></em></p>
                        <p><em>La favicon de ce site a été fournie par <a href="https://www.flaticon.com/fr/chercher?word=john%20doe" className="d-inline text-primary text-decoration-underline" target="_blank">John doe Icons erstellt von Freepik - Flaticon</a></em></p>
                    </div>
                    </div>
                </div>
            </div>
