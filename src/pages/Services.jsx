            ...
            <div className="container-fluid mb-5">
                <div className="row mx-2 mx-sm-0 justify-content-center">
                    <div className="col-md-3 col-12 mb-3 mb-sm-0 text-center border border-2 rounded ">
                        ...
                        <p className="fluid-text-2">L'UX Design est une discipline qui consiste à concevoir des produits (sites web, applications mobiles, logiciels, objets connectés, etc.)
                    ...
                    <div className="col-md-3 col-12 text-center text-break border border-2 rounded ">
                        ...
                        <p className="fluid-text-2">Le référencement naturel (SEO) est une technique qui consiste à optimiser un site web pour le faire remonter dans les résultats des moteurs de 
