            ...
            <main>
                ...
                <div class="accordion container my-7 w-75 min-vh-43 justify-content-center align-items-center" id="mentionsAccordion">
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-body">
                            ...
                            <p>
                                ...
                                <a href="#" className="text-decoration-underline d-inline text-primary" target="_blank">www.alwaysdata.com</a>
                            </p>
                        </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div class="accordion-body">
                            <h3>Crédits</h3>
                            <p>Ce site a été réalisé par John Doe, étudiant au <a href="https://www.centre-europeen-formation.fr/" className="d-inline text-primary text-decoration-underline" target="_blank">Centre Européen de Formation</a></p>
                            <p className="fst-italic">Les images utilisées sur ce site sont libres de droits et ont été obtenues sur le site <a href="https://pixabay.com/fr/" className="d-inline text-primary text-decoration-underline" target="_blank">Pixabay</a></p>
                            <p className="fst-italic">La favicon de ce site a été fournie par <a href="https://www.flaticon.com/fr/chercher?word=john%20doe" className="d-inline text-primary text-decoration-underline" target="_blank">John doe Icons erstellt von Freepik - Flaticon</a></p>
                        </div>
                        </div>
                    </div>
                </div>
