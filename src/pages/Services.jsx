           ...
           <section>
                <div className="container-fluid mb-5">
                    <div className="row mx-2 mx-sm-0 justify-content-center">
                        <div className="col-md-3 col-12 card card-hover text-center">
                            <div className="card-body">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-brush card-img-top text-primary mt-4 mb-4" viewBox="0 0 16 16">
                                ...
                                <p className="card-text">L'UX Design est une discipline qui consiste à <strong className="fw-normal">concevoir des produits</strong> (<em className="fst-normal">sites web, applications mobiles, logiciels, objets connectés</em>, etc.)
                        ...
                        <div className="col-md-3 col-12 mx-sm-4 mx-3 mb-3 mb-sm-0 card card-hover text-center">
                            <div className="card-body">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-code-slash card-img-top text-primary mt-4 mb-4" viewBox="0 0 16 16">
                        ...
                        <div className="col-md-3 col-12 text-center card card-hover">
                            <div className="card-body">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-search text-primary card-img-top mt-4 mb-4" viewBox="0 0 16 16">
                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                                </svg>
                                <h2 className="card-title">Référencement</h2>
                                <p className="card-text">Le référencement naturel (SEO) est une technique qui <strong className="fw-normal">consiste à optimiser un site web</strong> pour le faire remonter dans les résultats des moteurs de 
