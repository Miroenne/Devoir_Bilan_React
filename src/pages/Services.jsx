...
const Services = () => {
    return(
        <main>
           <div className="container-fluid ps-0 pe-0 bg-banner vh-25 min-vw-100">            
           </div>
           <div>
            <div className="text-center mt-5 mb-5 ">                
                <h1 className="">Mon offre de services</h1>
                <p>Voici les prestations sur lesquelles je peu intervenir</p>
            ...
            <div className="container-fluid mb-5">
                <div className="row ms-2 me-2 ms-sm-0 me-sm-0 justify-content-center">
                    <div className="col-sm-3 col-12 text-center border border-2 rounded ">
                        ...
                        <h2>UX Design</h2>
                        <p>L'UX Design est une discipline qui consiste à concevoir des produits (sites web, applications mobiles, logiciels, objets connectés, etc.)
                    ...
                    <div className="col-sm-3 col-12 ms-sm-4 me-sm-4 ms-3 me-3 text-center border border-2 rounded ">
                    ...
                    <div className="col-sm-3 col-12 text-center border border-2 rounded ">
                        ...
                        <p>Le référencement naturel (SEO) est une technique qui consiste à optimiser un site web pour le faire remonter dans les résultats des moteurs de 
                            recherche (Google, Bing, Yahoo, etc.). L'objectif est d'attirer un maximum de visiteurs qualifiés sur le site.
                        </p>
                    </div>
                </div>
