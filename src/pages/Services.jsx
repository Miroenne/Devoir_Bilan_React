           ...
           <div>
            ...
            <div className="container-fluid">
                <div className="row justify-content-center">
                    <div className="col-md-4 col-sm-12 text-center border border-2 rounded w-30">
                    ...
                    <div className="col-md-4 col-sm-12 ms-3 me-3 text-center border border-2 rounded w-30">
